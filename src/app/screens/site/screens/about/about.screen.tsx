...
const aboutCards = [
    ...
    {
        title: "Segurança",
        subtitle: "Envio de notificações personalizadas diretamente ao cliente.",
        className: "row p-4",
        icon: (<ImPlus />),
    },
];
...
const cultureCards = [
    {
        title: "Visão",
        text: "Crescimento sustentável e contínuo, " +
    ...
    {
        title: "Missão",
        text: "Oferecer melhores soluções dos nossos " +
                    ...
                    <div className="row m-4 justify-content-between">
                        <div className="col-md-6 text-start ">
                            ...
                            <p className="fs-6 m-3">
                                Somos uma transportadora que oferece aos clientes uma completa infraestrutura de serviços, com centros de distribuição e tecnologia de ponta. Trabalhamos com rapidez, qualidade e segurança, proporcionando resultados mais eficientes para suas operações.

                                Com especialização em last mile, possuímos uma dedicada equipe de apoio e acompanhamento dos serviços para garantir o atendimento personalizado e a satisfação dos clientes.

                                Operamos um sofisticado e eficaz sistema logístico, que nos permite estar nos principais mercados do Brasil, oferecendo soluções de forma rápida, econômica e no prazo certo que o cliente necessita.
                            </p>
                        </div>
                        <div className="
                            col-md-5 
                        ...
                        >
                            ...
                            >
                                ...
                                {aboutCards.map((values, index) => {
                                    return (
                                        <div key={index} className={values.className}>
